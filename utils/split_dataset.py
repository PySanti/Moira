...
"""
make_valset_autumn.py

Lee dataset.csv, extrae todos los registros de otoño y los guarda en valset.csv.
Luego ELIMINA esos registros del dataset original (sobrescribe dataset.csv),
...
Uso:
  python3 make_valset_autumn.py --csv dataset.csv --val valset.csv

Opcional:
  python3 make_valset_autumn.py --csv dataset.csv --date-col date
  python3 make_valset_autumn.py --csv dataset.csv --definition astronomical
  python3 make_valset_autumn.py --csv dataset.csv --city-col ciudad --city "New York"
"""
...
def main():
    ...
    ap.add_argument("--csv", default="dataset.csv", help="Ruta del dataset (default: dataset.csv)")
    ap.add_argument("--val", default="valset.csv", help="Ruta del valset (default: valset.csv)")
